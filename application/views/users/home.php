        ...
        <div class="row">
          <div class="col-xl-9 text-left mx-auto">
            <h1 >Dijamin Bersih, Rapi, dan Wangi.</h1>
              <p class="mb-5" style="margin-top:-10px; font-size: 13px ">Jasa laundry kiloan dan satuan, Kami sudah melayani ratusan pelanggan dari hampir seluruh Buah Batu</p>
          </div>
